...
! function() {
    ...
    ! function(c) {
        ...
        ! function c(l, z) {
            ...
            "function" == typeof t.hooks.addPack ? t.hooks.addPack(l, h) : t.styles[l] = M({}, t.styles[l] || {}, h), "fas" === l && c("fa", z)
        }("fas", f)
    })
}(),
function() {
    ...
    try {
        "undefined" != typeof window && (l = window), "undefined" != typeof document && (h = document), "undefined" != typeof MutationObserver && (z = MutationObserver), "undefined" != typeof performance && (v = performance)
    } catch (c) {}
    var m = (l.navigator || {}).userAgent,
        ...
        w = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter"].concat(d.map(function(c) {
            return c + "x"
    ...
    var T = P[f],
        _ = [],
        R = !1;
    M && ((R = (H.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(H.readyState)) || H.addEventListener("DOMContentLoaded", function c() {
        H.removeEventListener("DOMContentLoaded", c), R = 1, _.map(function(c) {
            return c()
        })
    }));
    var F = function(c) {
            M && (R ? setTimeout(c, 0) : _.push(c))
        },
        I = b,
        W = {
            size: 16,
    ...
    function U(c) {
        return c.classList ? X(c.classList) : (c.getAttribute("class") || "").split(" ").filter(function(c) {
            return c
        })
    }
    ...
    function Q(c) {
        return c.size !== W.size || c.x !== W.x || c.y !== W.y || c.rotate !== W.rotate || c.flipX || c.flipY
    }
    ...
    function vc(c) {
        var l = c.icons,
            ...
            V = [E.replacementClass, m ? E.familyPrefix + "-" + m : "", n].filter(function(c) {
        ...
        f && (o.attributes[g] = ""), a && o.children.push({
            tag: "title",
            attributes: {
                id: o.attributes["aria-labelledby"] || "title-" + D()
            },
            children: [a]
        });
        var C = A({}, o, {
    ...
    function mc(c) {
        ...
        a && (t[g] = "");
        var M, f, r, H, i, n, V, o, C, L = A({}, s.styles);
        Q(v) && (L.transform = (f = (M = {
            transform: v,
            startCentered: !0,
            width: h,
            height: z
        }).transform, r = M.width, H = void 0 === r ? b : r, i = M.height, n = void 0 === i ? b : i, V = M.startCentered, C = "", C += (o = void 0 !== V && V) && p ? "translate(" + (f.x / I - H / 2) + "em, " + (f.y / I - n / 2) + "em) " : o ? "translate(calc(-50% + " + f.x / I + "em), calc(-50% + " + f.y / I + "em)) " : "translate(" + f.x / I + "em, " + f.y / I + "em) ", C += "scale(" + f.size / I * (f.flipX ? -1 : 1) + ", " + f.size / I * (f.flipY ? -1 : 1) + ") ", C += "rotate(" + f.rotate + "deg) "), L["-webkit-transform"] = L.transform);
        var u = J(L);
    ...
    var sc = function() {},
        ec = E.measurePerformance && a && a.mark && a.measure ? a : {
            mark: sc,
            measure: sc
        },
        ac = 'FA "5.3.1"',
    ...
    var yc = {
        ...
        nest: function(c) {
            ...
            var v = h[0].attributes.class.split(" ").reduce(function(c, l) {
                return l === E.replacementClass || l.match(z) ? c.toSvg.push(l) : c.toNode.push(l), c
            }, {
                toNode: [],
                toSvg: []
            });
    ...
    function wc(h, c) {
        ...
        0 === h.length ? z() : (r.requestAnimationFrame || function(c) {
            return c()
        })(function() {
    ...
    var Oc = function(c) {
            var l, h, z = c.getAttribute("data-prefix"),
                ...
                s = dc(U(c));
            return z && v && (s.prefix = z, s.iconName = v), s.prefix && 1 < m.length ? s.iconName = (l = s.prefix, h = c.innerText, nc[l][h]) : s.prefix && 1 === m.length && (s.iconName = Cc(s.prefix, jc(c.innerText))), s
        },
        Nc = function(c) {
            var l = {
                size: 16,
        ...
        Tc = function(c) {
            var l = X(c.attributes).reduce(function(c, l) {
    ...
    }(Fc.prototype = Object.create(Error.prototype)).constructor = Fc;
    var Ic = {
            fill: "currentColor"
        },
        Wc = {
    ...
    function Zc(c) {
        var l, h, z, v, m, s, e, a, t, M, f, r, H, i, n, V, o, C, L, u = (h = Oc(l = c), z = h.iconName, v = h.prefix, m = h.rest, s = qc(l), e = Ec(l), a = Pc(l), t = Tc(l), M = _c(l), {
            iconName: z,
        ...
        }(c, u) : (f = c, H = (r = u).iconName, i = r.title, n = r.prefix, V = r.transform, o = r.symbol, C = r.mask, L = r.extra, [f, vc({
            icons: {
                main: Qc(H, n),
    ...
    function $c(c) {
        if (M) {
            ...
            kc = !0,
                function() {
                    X(c.querySelectorAll("*")).filter(function(c) {
                        return !(c.parentNode === document.head || ~L.indexOf(c.tagName.toUpperCase()) || c.getAttribute(n) || c.parentNode && "svg" === c.parentNode.tagName)
                    }).forEach(function(f) {
                        [":before", ":after"].forEach(function(l) {
                            var c = X(f.children).filter(function(c) {
    ...
    function cl(c) {
        ...
        if (M) {
            var h = H.documentElement.classList,
                ...
                m = Object.keys(Xc),
                s = ["." + Uc + ":not([" + g + "])"].concat(m.map(function(c) {
                    return "." + c + ":not([" + g + "])"
                })).join(", ");
            if (0 !== s.length) {
                    ...
                    var a = Mc.begin("onTree"),
                        t = e.reduce(function(c, l) {
                            try {
                                ...
                                u || c instanceof Fc && console.error(c)
                            }
                            return c
                        }, []);
                    a(), wc(t, function() {
    ...
    var el, al = new(function() {
                    ...
                    Object.keys(v).forEach(function(c) {
                        l.definitions[c] = A({}, l.definitions[c] || {}, v[c]),
                            function c(l, z) {
                                ...
                                "function" == typeof T.hooks.addPack ? T.hooks.addPack(l, h) : T.styles[l] = A({}, T.styles[l] || {}, h), "fas" === l && c("fa", z)
                            }(c, v[c]), oc()
                    })
                }
            }, {
        ...
        Ml = {
            ...
            watch: function() {
                ...
                !1 === E.autoReplaceSvg && (E.autoReplaceSvg = !0), E.observeMutations = !0, F(function() {
                    Hl({
        ...
        fl = (el = function(c) {
            ...
            if (c) {
                ...
                return ml(A({
                    ...
                    return vl(), E.autoA11y && (t ? H["aria-labelledby"] = E.replacementClass + "-title-" + D() : H["aria-hidden"] = "true"), vc({
                        icons: {
                            main: zl(C),
                            mask: e ? zl(e.icon) : {
                                found: !1,
        ...
        Hl = function() {
            var c = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
                l = void 0 === c ? H : c;
            0 < Object.keys(T.styles).length && M && E.autoReplaceSvg && rl.dom.i2svg({
                node: l
            })
        };
    ! function(c) {
        ...
        t && (r.FontAwesome || (r.FontAwesome = rl), F(function() {
            Hl(), Ac({
                treeCallback: cl,
                nodeCallback: ll,
                pseudoElementsCallback: $c
            ...
            addPack: function(c, l) {
                T.styles[c] = A({}, T.styles[c] || {}, l), oc(), Hl()
            },
            addShims: function(c) {
                var l;
